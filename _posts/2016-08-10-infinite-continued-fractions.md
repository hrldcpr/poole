...
Interestingly, you can bound continued fractions in almost exactly the same way as digits. The only difference is that the bounds alternate back-and-forth, because even coefficients increase the number, but odd coefficients decrease it.
...
1 \le 1 + \dots \le 2
\\
1 + \frac{1}{2} \ge 1 + \frac{1}{2 + \dots} \ge 1 + \frac{1}{3}
\\
1 + \frac{1}{2 + \frac{1}{3}} \le 1 + \frac{1}{2 + \frac{1}{3 + \dots}} \le 1 + \frac{1}{2 + \frac{1}{4}}
$$
...
This is almost exactly the same as the digit bounds:
